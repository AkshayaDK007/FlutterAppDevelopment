...
import 'package:my_app/components/Boysblock.dart';
import 'package:my_app/components/my_button.dart';
import 'package:searchfield/searchfield.dart';
import 'package:provider/provider.dart';

class UserBoysData extends ChangeNotifier {
  String? username;
  String? rollno;
  String? contactno;
  String? roomno;
...
class Boys extends StatelessWidget {
  // Boys({required this.deptcontroller});

  //final blocknocontroller;
  ...
  Boys({this.selectedDepartment, this.selectedBlock});
  ...
  void _navigateToDisplayPage(BuildContext context) {
    final userData = Provider.of<UserBoysData>(context, listen: false);
